...
<div class="row">
  <div class="col-12 col-md-8"><table class="table table-sm table-dark">
  <thead>
    <tr>
      <th scope="col">#</th>
  ...
  <div class="col-6 col-md-4"><table class="table table-sm table-dark">
  <thead>
    <tr>
      <th scope="col">#</th>
      <th scope="col">First</th>
...
<div class="row">
  <div class="col-6 col-md-4"><table class="table">
  ...
  <div class="col-6 col-md-4"><a href=#><figure class="figure">
